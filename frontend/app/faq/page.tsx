        ...
        <div className="flex flex-1">
          ...
          <div className="w-3/5 p-8 space-y-6 overflow-y-auto">
            <div>
              ...
              <p className="text-muted-foreground">
                Use the &quot;Add Project&quot; button on the dashboard to
                create a new project. Fill out the form and submit.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Yes, navigate to the &quot;Team&quot; section in the sidebar and
                click &quot;Create Team&quot; to manage members.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Go to the &quot;Tasks&quot; section or use the &quot;Add
                Task&quot; button on the dashboard to manage them.
              </p>
            </div>
